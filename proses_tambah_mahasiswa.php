...
if ($_POST) {
	...
	if(empty($nama)){
		...
		include "koneksi.php";
		$insert = mysqli_query($conn, "insert into t_mahasiswa (nama, tanggal_lahir, jenis_kelamin, alamat, username, password, id_jurusan) value ('".$nama."','".$tanggal_lahir."','".$jenis_kelamin."',
		'".$alamat."','".$username."', '".$password."', '".$id_jurusan."')")or die(mysqli_error($conn));
	if($insert){
